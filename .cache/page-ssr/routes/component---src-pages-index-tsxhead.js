...
/* harmony export */   fetchRepositories: () => (/* binding */ fetchRepositories)
/* harmony export */ });
...
async function fetchRepositories() {
  const accessToken = "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";
...
const IndexPage = () => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const getRepositories = async () => {
      try {
        const repositories = await (0,_controllers_githubApi__WEBPACK_IMPORTED_MODULE_1__.fetchRepositories)();
