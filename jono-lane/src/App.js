    ...
    <div>
      ...
      <nav className="navbar navbar-expand-lg fixed-top navbar-dark navbarScroll">
        <div className="container">
          <a className="navbar-brand" href="#">Jono</a>
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 hero-text">
              <h2 className="hero_title">Hi, it's me Jono</h2>
              <p className="hero_desc">I am a professional freelancer in Nashville</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mt-4 pt-4">
          ...
          <div className="row mt-4">
            <div className="col-lg-4">
              <img src="images/headshot.jpg" className="imageAboutPage" alt />
            </div>
          ...
          <div className="row mt-4">
            <div className="col-lg-6">
              ...
              <div style={{ maxWidth: '100%', overflow: 'hidden', color: 'red', width: 500, height: 500 }}>
                ...
                <style dangerouslySetInnerHTML={{ __html: "#embedmap-canvas img{max-width:none!important;background:none!important;font-size: inherit;font-weight:inherit;}\n                        " }} />
              </div>
            </div>
            <div className="col-lg-6">
              {/* form fields */}
              <form>
                ...
                <div className="mb-3 mt-3">
                  <textarea className="form-control" rows={5} id="comment" name="text" placeholder="Project Details" defaultValue={""} />
                </div>
              </form>
      ...
      <footer id="footer">
        <div className="container-fluid">
          ...
          <div className="social-icons mt-4">
            ...
            <a href="https://www.twitch.tv/" target="_blank"><i className="fab fa-twitch" /></a>
          </div>
        </div>
      </footer>
    </div>
